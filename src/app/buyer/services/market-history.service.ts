...
const MARKET_HISTORY_STAT_PATH = '/buyer/history/get_market_stat';
const HISTORY_AWARDED_LIST = '/buyer/history/get_awarded_list';
const DOWNLOAD_AWARDED_DETAILS = '/buyer/history/download_awarded_detail';
const MARKET_GRAPH_PATH = '/buyer/history/get_market_graph';
...
export class MarketHistoryService {
  ...
  public get(id: string, filter: Object): Observable<HistoryMarket> {
    let params = new HttpParams().set('buy-id', id);
